...
- Use Element UI only. Input/select heights: 28px dense toolbar, 32px default filters, 36/40px important forms.
- Give each page one clear primary button. Put destructive actions behind confirmation.
