...
- [ ] Page mode matches the task and Figma tokens are used (`#0080FF`, type scale, 4px radius, correct borders/background).
- [ ] Element UI is the sole page UI library; hierarchy and long-text behavior are clear.
